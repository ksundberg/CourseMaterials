...
<node TEXT="Mandelbrot Set" ID="ID_1885014969" CREATED="1389469379342" MODIFIED="1389469386851">
<node TEXT="$z_{n+1} = z_n^2 + c$" ID="ID_1374754598" CREATED="1389483192748" MODIFIED="1389484192014"/>
<node TEXT="set of $z$ where $z_n$ is bounded for all $n$" ID="ID_829950063" CREATED="1389484193112" MODIFIED="1389484217908"/>
<node TEXT="Images colored by how quickly a point is found to \emph{not} be in the set" ID="ID_1703012296" CREATED="1389484240079" MODIFIED="1389484260169"/>
</node>
<node TEXT="Mandelbrot Psuedocode (from wikipedia)" ID="ID_1670167946" CREATED="1389484261086" MODIFIED="1389484272146">
<node TEXT="\url{http://en.wikipedia.org/wiki/Mandelbrot\_set\#Escape\_time\_algorithm}" ID="ID_1146032837" CREATED="1389484273061" MODIFIED="1389488385309"/>
<node TEXT="Feel free to start from this, the point will be to thread this algorithm" ID="ID_1573500986" CREATED="1389484469118" MODIFIED="1389488401539"/>
</node>
<node TEXT="PPM Format" ID="ID_1367132788" CREATED="1389484308156" MODIFIED="1389484311025">
<node TEXT="Very simple image format" ID="ID_361021755" CREATED="1389484315995" MODIFIED="1389484321961"/>
<node TEXT="\url{http://netpbm.sourceforge.net/doc/ppm.html}" ID="ID_1535838699" CREATED="1389484325107" MODIFIED="1389488017677"/>
<node TEXT="P3" ID="ID_134251223" CREATED="1389484400024" MODIFIED="1389484414037"/>
<node TEXT="width height" ID="ID_124953106" CREATED="1389484414616" MODIFIED="1389484419189"/>
<node TEXT="color depth" ID="ID_105721540" CREATED="1389484419576" MODIFIED="1389484425453"/>
<node TEXT="r g b pixels" ID="ID_751927188" CREATED="1389484425887" MODIFIED="1389484446356"/>
</node>
</node>
