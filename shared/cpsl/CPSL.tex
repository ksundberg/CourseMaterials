...
The signature of every procedure and function must be unique.
The signature consists of the name of the function as well as the number, type, and order of the parameters.
