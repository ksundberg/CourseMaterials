...
<node TEXT="Definition" ID="ID_1161089311" CREATED="1439933872329" MODIFIED="1440014520041">
...
<node TEXT="void moveDisk(int n, std::string from, std::string to, std::string other)" ID="ID_793285328" CREATED="1440094101187" MODIFIED="1440094153751"/>
