...
<node TEXT="Starting Out with C++: Early Objects" ID="ID_382147496" CREATED="1433014016765" MODIFIED="1433014064754"/>
<node TEXT="ISBN: 978-0133360929" ID="ID_1932376874" CREATED="1433014065333" MODIFIED="1433014079745"/>
</node>
...
<node TEXT="Assignments: 70" ID="ID_1423457656" CREATED="1433015035685" MODIFIED="1435436893761"/>
<node TEXT="Quizzes: 10" ID="ID_635252124" CREATED="1433015056818" MODIFIED="1433015060980"/>
<node TEXT="Exams: 20" ID="ID_1643166868" CREATED="1433015061442" MODIFIED="1435436890628"/>
</node>
...
<node TEXT="Computers are then great tools for executing these steps - called \emph{algorithms}" ID="ID_506108416" CREATED="1433015680835" MODIFIED="1433015717325"/>
</node>
...
<node TEXT="Prepared to take further CS courses" LOCALIZED_STYLE_REF="styles.topic" ID="ID_1976267930" CREATED="1433015770577" MODIFIED="1433015835838"/>
<node TEXT="Greatly improved problem solving skills" LOCALIZED_STYLE_REF="styles.topic" ID="ID_504805621" CREATED="1433015790880" MODIFIED="1433015835832"/>
<node TEXT="Focus on Principles not on Spelling" LOCALIZED_STYLE_REF="styles.topic" ID="ID_311307422" CREATED="1431978643619" MODIFIED="1433016540388"/>
<node TEXT="Stretch Goal: Help you be a better person" ID="ID_21547332" CREATED="1433016504927" MODIFIED="1433016526654"/>
</node>
</node>
<node TEXT="Problem Solving" ID="ID_1077799941" CREATED="1430766416273" MODIFIED="1430766426934">
<node TEXT="Algorithms" ID="ID_1357311234" CREATED="1433015874581" MODIFIED="1433015878688">
<node TEXT="Precise" ID="ID_1297680504" CREATED="1433015881045" MODIFIED="1433015903111"/>
<node TEXT="Unambiguous" ID="ID_41124328" CREATED="1433015903652" MODIFIED="1433015913582"/>
...
<node TEXT="Von Nuemann showed how to build one (1945) - well an approximation" LOCALIZED_STYLE_REF="styles.topic" ID="ID_1584716349" CREATED="1433016111861" MODIFIED="1433016279638"/>
<node TEXT="Instructions that a computer can understand meet the requirements" ID="ID_1571849543" CREATED="1433016246136" MODIFIED="1433016268017"/>
</node>
...
<node TEXT="Coupling happens when one part of a program interacts with another part of a program" LOCALIZED_STYLE_REF="styles.topic" ID="ID_174535510" CREATED="1430767097393" MODIFIED="1433012490984"/>
<node TEXT="Coupling should be closely controlled and well understood" LOCALIZED_STYLE_REF="styles.topic" ID="ID_1363414419" CREATED="1430767145193" MODIFIED="1433012498811"/>
</node>
...
<node TEXT="Not every detail matters" LOCALIZED_STYLE_REF="styles.topic" ID="ID_1730653724" CREATED="1430767167699" MODIFIED="1433012783405"/>
<node TEXT="Assume as little as possible" ID="ID_907783709" CREATED="1430767175145" MODIFIED="1433012809837"/>
<node TEXT="Leads to more generic and more correct programs" ID="ID_733759796" CREATED="1430767190625" MODIFIED="1430767198434"/>
</node>
<node TEXT="Avoid Special Cases" ID="ID_1722258769" CREATED="1433016403842" MODIFIED="1433016417812">
<node TEXT="Remember: ``You are not the Special&apos;&apos;" LOCALIZED_STYLE_REF="styles.topic" ID="ID_1555140307" CREATED="1433016417824" MODIFIED="1433016499407"/>
<node TEXT="The need for special cases and exceptions to rules is an indication of a bad abstraction" ID="ID_1660985415" CREATED="1433016441849" MODIFIED="1433016461961"/>
<node TEXT="Follow the 0-1-many rule" ID="ID_1775756004" CREATED="1433016462704" MODIFIED="1433016492304"/>
</node>
<node TEXT="Keep It Simple ..." ID="ID_979291179" CREATED="1430767200481" MODIFIED="1430767207591">
<node TEXT="Don&apos;t be clever, be correct" LOCALIZED_STYLE_REF="default" ID="ID_546355644" CREATED="1430767242736" MODIFIED="1433012663033"/>
...
<node TEXT="Computers only understand machine language" LOCALIZED_STYLE_REF="styles.topic" ID="ID_1505356907" CREATED="1430767345735" MODIFIED="1433017412184">
...
<node TEXT="Humans use natural languages" LOCALIZED_STYLE_REF="styles.topic" ID="ID_172239796" CREATED="1430767400505" MODIFIED="1433017412182">
...
<node TEXT="Programming languages are a compromise" LOCALIZED_STYLE_REF="styles.topic" ID="ID_1826226160" CREATED="1430767441513" MODIFIED="1433017412177">
...
<node TEXT="BCPL (Ken Thompson 1969)" ID="ID_161505606" CREATED="1433823844205" MODIFIED="1433823943791"/>
<node TEXT="C (Dennis Ritchie 1972)" ID="ID_1342391328" CREATED="1433823848182" MODIFIED="1433823925557"/>
<node TEXT="Simula (Ole-Johan Dahl and Kristen Nygaard 1967)" ID="ID_1213626281" CREATED="1433824348799" MODIFIED="1433824409415"/>
</node>
<node TEXT="Standardization" ID="ID_1969735954" CREATED="1433824118173" MODIFIED="1433824122903">
<node TEXT="First standardized in 1998" ID="ID_755763429" CREATED="1433824122917" MODIFIED="1433824267789"/>
<node TEXT="Also 2003, 2011,2014" ID="ID_1701188834" CREATED="1433824268436" MODIFIED="1433824280917"/>
</node>
<node TEXT="Backwards compatibility is a key feature" ID="ID_528878547" CREATED="1433824288768" MODIFIED="1433824304339">
<node TEXT="Old ways of doing things still work" ID="ID_1176604786" CREATED="1433824304350" MODIFIED="1433824311636"/>
<node TEXT="I will teach the current best practices" ID="ID_1008342984" CREATED="1433824312103" MODIFIED="1433824324115"/>
<node TEXT="Textbook is a bit outdated" ID="ID_91156456" CREATED="1433824326023" MODIFIED="1433824333345"/>
</node>
</node>
...
<node TEXT="Development" ID="ID_1326838342" CREATED="1430767519168" MODIFIED="1433017497724">
...
<node TEXT="Compilation" LOCALIZED_STYLE_REF="styles.topic" ID="ID_1441795666" CREATED="1430767537041" MODIFIED="1433016738924">
...
<node TEXT="Optimization" LOCALIZED_STYLE_REF="styles.topic" ID="ID_1394602393" CREATED="1430767577945" MODIFIED="1433016738920">
<node TEXT="Optimizing compilers modify code for performance" ID="ID_334741715" CREATED="1430767580940" MODIFIED="1430767595160"/>
</node>
<node TEXT="Assembly" LOCALIZED_STYLE_REF="styles.topic" ID="ID_990931428" CREATED="1430767596136" MODIFIED="1433016738917">
...
<node TEXT="Linking" LOCALIZED_STYLE_REF="styles.topic" ID="ID_982122595" CREATED="1430767670633" MODIFIED="1433016738913">
...
<node TEXT="Loading" LOCALIZED_STYLE_REF="styles.topic" ID="ID_531586518" CREATED="1430767691032" MODIFIED="1433016738910">
<node TEXT="Operating system loads executable code" ID="ID_1943341826" CREATED="1430767693769" MODIFIED="1430767701014"/>
</node>
<node TEXT="Execution" ID="ID_1684454759" CREATED="1430767701737" MODIFIED="1433017502688">
...
<node TEXT="Compiler and Linker (g++, VC)" ID="ID_640658987" CREATED="1430767810721" MODIFIED="1433017554485"/>
...
<node TEXT="Integrated Development Environment (Visual Studio, Eclipse)" ID="ID_110485493" CREATED="1430767819696" MODIFIED="1433016781992"/>
</node>
<node TEXT="Obtaining Necessary Tools" ID="ID_1286726494" CREATED="1435436654042" MODIFIED="1435436681926">
<node TEXT="Microsoft" ID="ID_94524326" CREATED="1435436681937" MODIFIED="1435436695246">
<node TEXT="Department is part of DreamSpark" ID="ID_112074688" CREATED="1435436695263" MODIFIED="1435436716139"/>
<node TEXT="Instructions for downloading Microsoft tools are on the department website" ID="ID_1389187456" CREATED="1435436716725" MODIFIED="1435436742087"/>
</node>
<node TEXT="OS X" ID="ID_651154437" CREATED="1435436784626" MODIFIED="1435436787356">
<node TEXT="XCode can be freely downloaded from Apple" ID="ID_656882426" CREATED="1435436787364" MODIFIED="1435436803910"/>
</node>
<node TEXT="Linux" ID="ID_1215553135" CREATED="1435436743276" MODIFIED="1435436760665">
<node TEXT="Probably installed by default" ID="ID_1078091143" CREATED="1435436748724" MODIFIED="1435436771556"/>
<node TEXT="Use your package manager" ID="ID_1980312673" CREATED="1435436772059" MODIFIED="1435436814365"/>
</node>
</node>
...
<node TEXT="Identifiers" LOCALIZED_STYLE_REF="styles.topic" ID="ID_1305495970" CREATED="1433823114201" MODIFIED="1433823285890">
<node TEXT="User defined names" ID="ID_698493965" CREATED="1433823118042" MODIFIED="1433823122284"/>
<node TEXT="Start with a letter" ID="ID_1414472122" CREATED="1433823122792" MODIFIED="1433823150891"/>
<node TEXT="May contain letters, digits, and underscores" ID="ID_843448825" CREATED="1433823151455" MODIFIED="1433823182522"/>
</node>
<node TEXT="Punctuation" ID="ID_1413425815" CREATED="1433823252163" MODIFIED="1433823256918">
<node TEXT="Various symbols with predefined meanings" ID="ID_1839084385" CREATED="1433823256938" MODIFIED="1433823276812"/>
</node>
</node>
...
<node TEXT="Semantics" ID="ID_322306889" CREATED="1433823081575" MODIFIED="1433823084646">
<node TEXT="The `meaning&apos; of code" LOCALIZED_STYLE_REF="styles.topic" ID="ID_815146675" CREATED="1433823297762" MODIFIED="1433823377783"/>
<node TEXT="Compiler can&apos;t help here" ID="ID_1744191956" CREATED="1433823313122" MODIFIED="1433823319793">
<node TEXT="Identifiers that begin with underscore are reserved for the STL" ID="ID_1070093239" CREATED="1433823330313" MODIFIED="1433823346630"/>
<node TEXT="Identifiers that begin with two underscores are reserved for compiler implementation" ID="ID_792736372" CREATED="1433823347089" MODIFIED="1433823361721"/>
</node>
</node>
</node>
</node>
