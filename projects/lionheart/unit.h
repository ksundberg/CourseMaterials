...
struct Action{  // this struct helps define the details of each action
...
public:
	...
	Unit(int ir,int ic,int ihp,Dir idir,Rank irank,
	     bool idead, std::string itla);    //check for errors, exit if any found
  ...
  std::string getTla();
	...
	int Attack();          // attack, return hits.  see official rules for dice rolls
