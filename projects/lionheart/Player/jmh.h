...
public:
  ...
  jmh(int ir, int ic, int ihp, Dir idir, Rank irank, bool idead, string itla)
  ...
  void setUnitid(int newUnitid) { unitid = newUnitid; }

  void setUnitorder(int newUnitorder) { unitorder = newUnitorder; }
  ...
  int getOrders() { return unitorder; }
  ...
  int getside() { return sideofmap; }

  void setside(int newside) { sideofmap = newside; }
